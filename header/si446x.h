...
#define PORT_SI_CSN     GPIO_PORT_P5   // for TM_V3.0
#define PIN_SI_CSN      GPIO_PIN0

#define PORT_SI_SDN     GPIO_PORT_P1
#define PIN_SI_SDN      GPIO_PIN5

/*
#define PORT_SI_CSN     GPIO_PORT_P1   // for TM_V2.0
#define PIN_SI_CSN      GPIO_PIN3
*/

#define PORT_SI_SDN     GPIO_PORT_P1
#define PIN_SI_SDN      GPIO_PIN5

#define PORT_SI_GIO0    GPIO_PORT_P8
#define PIN_SI_GIO0     GPIO_PIN1

#define PORT_SI_GIO1    GPIO_PORT_P1
#define PIN_SI_GIO1     GPIO_PIN7

//#define SI_CSN_LOW()   GPIO_ResetBits(PORT_SI_CSN, PIN_SI_CSN);
//#define SI_CSN_HIGH()  GPIO_SetBits(PORT_SI_CSN, PIN_SI_CSN);
#define SI_CSN_LOW()   GPIO_setOutputLowOnPin(PORT_SI_CSN, PIN_SI_CSN);
#define SI_CSN_HIGH()  GPIO_setOutputHighOnPin(PORT_SI_CSN, PIN_SI_CSN);

#define SI_SDN_LOW()   GPIO_setOutputLowOnPin(PORT_SI_SDN, PIN_SI_SDN);
#define SI_SDN_HIGH()  GPIO_setOutputHighOnPin(PORT_SI_SDN, PIN_SI_SDN);

#define IWDG_ReloadCounter() while(0) //not use WDG
